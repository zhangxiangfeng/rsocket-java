...
class RequestResponseMono extends Mono<Payload> implements Scannable {
    ...
    RequestResponseMono(@NonNull ByteBufAllocator allocator, @NonNull Payload payload, @NonNull StateAware parent, @NonNull StreamIdSupplier streamIdSupplier, @NonNull IntObjectMap<?> activeStreams, @NonNull UnboundedProcessor<ByteBuf> sendProcessor) {
