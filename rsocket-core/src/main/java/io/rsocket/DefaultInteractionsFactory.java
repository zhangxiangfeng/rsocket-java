...
public class DefaultInteractionsFactory implements InteractionsFactory {
  ...
  public DefaultInteractionsFactory(
      StateAware stateAware,
      ByteBufAllocator allocator,
      StreamIdSupplier streamIdSupplier,
      IntObjectMap<Processor<Payload, Payload>> registry,
  ...
  public Mono<Void> fireAndForget(Payload payload) {
    //        return new UnicastFireAndForgetMono(allocator, payload, mtu, stateAware,
    // streamIdSupplier, registry, sendProcessor);
    return null;
  }
